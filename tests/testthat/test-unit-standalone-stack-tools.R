...
test_that(".lax_as_function unit test", {
  ...
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-stack-tools.R", line=21)
...
test_that(".get_fn_name unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-stack-tools.R", line=44)
  # or navigate to topic with <F2>
  F2 = .get_fn_name
...
test_that(".search_call_stack unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-stack-tools.R", line=89)
  # or navigate to topic with <F2>
...
test_that(".find_namespace unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-stack-tools.R", line=135)
  # or navigate to topic with <F2>
  F2 = .find_namespace
