...
test_that(".gg_fonts_missing unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-ggplot-utils.R", line=356)
  # or navigate to topic with <F2>
  F2 = .gg_fonts_missing
...
test_that(".gg_breaks_log1p unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-ggplot-utils.R", line=396)
  # or navigate to topic with <F2>
  F2 = .gg_breaks_log1p
...
test_that(".gg_transform_logit unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-ggplot-utils.R", line=421)
  # or navigate to topic with <F2>
...
test_that(".gg_layer unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-ggplot-utils.R", line=644)
  # or navigate to topic with <F2>
  F2 = .gg_layer
...
test_that(".gg_scale_y_logit unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-ggplot-utils.R", line=528)
  # or navigate to topic with <F2>
  F2 = .gg_scale_y_logit
...
test_that(".gg_scale_y_percent unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-ggplot-utils.R", line=567)
  # or navigate to topic with <F2>
