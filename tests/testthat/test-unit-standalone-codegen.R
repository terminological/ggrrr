...
test_that(".update_fenced_block unit test", {
  ...
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-codegen.R", line=74)
...
test_that(".delete_fenced_block unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-codegen.R", line=222)
  # or navigate to topic with <F2>
...
test_that(".glue_recover_pieces unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-codegen.R", line=329)
  # or navigate to topic with <F2>
...
test_that(".glue_detect_output unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-codegen.R", line=362)
  # or navigate to topic with <F2>
