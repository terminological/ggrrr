...
test_that(".locate_project unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-file-output-utils.R", line=185)
  # or navigate to topic with <F2>
  F2 = .locate_project
...
test_that(".here unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-file-output-utils.R", line=268)
  # or navigate to topic with <F2>
  F2 = .here
...
test_that(".find_chrome unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-file-output-utils.R", line=294)
  # or navigate to topic with <F2>
  F2 = .find_chrome
...
test_that(".print_svg_with_chrome unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-file-output-utils.R", line=358)
  # or navigate to topic with <F2>
...
test_that(".print_html_with_chrome unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-file-output-utils.R", line=457)
  # or navigate to topic with <F2>
...
test_that(".convert_pdf_to_pngs unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-file-output-utils.R", line=548)
  # or navigate to topic with <F2>
...
test_that(".gg_save_as unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-file-output-utils.R", line=704)
  # or navigate to topic with <F2>
  F2 = .gg_save_as
...
test_that(".hux_save_as unit test", {
  ...
  # generated by roxygen @unit tag
  # edit this at:
  # rstudioapi::documentOpen(path="R/standalone-file-output-utils.R", line=1022)
  # or navigate to topic with <F2>
  F2 = .hux_save_as
